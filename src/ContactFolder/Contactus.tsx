      ...
      <div className="p-6">
        ...
        <div className="mt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center">
          <div className="mb-4 sm:mb-0">
            ...
            <p className="text-sm text-amber-700">Easily accessible from Port Harcourt International Airport</p>
          </div>
          <a 
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-amber-700">gabbyshotel@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-amber-800">Opening Hours</h3>
