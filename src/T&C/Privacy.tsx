        ...
        <div className="p-8">
          <div className="mb-8">
            <p className="text-gray-700 text-lg leading-relaxed mb-6">
              At <span className="font-semibold text-amber-600">Gabby's Hotel</span>, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.
            </p>
          ...
          <div className="space-y-8">
            ...
            <PolicySection 
              ...
              content={
                <>
                  ...
                  <ul className="list-disc pl-6 mb-4 space-y-2">
                    <li>Secure servers and networks protected by firewalls and encryption</li>
                    <li>Restricted access to personal information on a need-to-know basis</li>
                    <li>Regular security assessments and updates</li>
                  </ul>
                  <p>While we strive to protect your personal information, no method of transmission over the Internet or electronic storage is 100% secure. We cannot guarantee absolute security of your data.</p>
                </>
              }
            />
            ...
            <PolicySection 
              ...
              content={
                <>
                  <p className="mb-4">We use cookies and similar tracking technologies to track activity on our website and hold certain information. Cookies are files with small amounts of data which may include an anonymous unique identifier.</p>
                  <p className="mb-4">You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if you do not accept cookies, you may not be able to use some portions of our website.</p>
            ...
            <PolicySection 
              ...
              content={
                <>
                  <p className="mb-4">We may employ third-party companies and individuals to facilitate our services ("Service Providers"), provide services on our behalf, perform service-related services, or assist us in analyzing how our services are used.</p>
            ...
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <a href="mailto:privacy@gabbyhotel.com" className="text-blue-600 hover:text-blue-800 font-medium transition-colors">
                ...
                <div className="flex items-center">
                  ...
                  <a href="tel:+1234567890" className="text-blue-600 hover:text-blue-800 font-medium transition-colors">
                    +1 (234) 567-890
                  </a>
                </div>
